package com.codebiz.projects.mapper.projects;
...
public class ProjectsMapper {
    ...
    public static Projects toEntity(ProjectsRequestDTO dto) {
        ...
        entity.startDate = (dto.startDate != null && !dto.startDate.isBlank())
                ? LocalDate.parse(dto.startDate)
                : null;

        entity.endDate = (dto.endDate != null && !dto.endDate.isBlank())
